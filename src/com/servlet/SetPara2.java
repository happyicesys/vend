...
public class SetPara2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // executePost("https://vend-system.happyice.com.sg/api/v1/vending-machine-transaction",
        ...
        if (!gprsdata.getStr_content().equals("{\"Type\":\"P\"}")) {
            ...
            executePost("https://vend-system.happyice.com.sg/api/v1/vending-machine-transaction", gprsdata.getStr_content());
        }
    ...
    private void forwardRequest(String method, HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            final URL url = new URL("https://vend-system.happyice.com.sg/api/v1/vending-machine-transaction"); // no
                                                                                                               // trailing
                                                                                                               // slash
            // + req.getRequestURI()
    ...
    void SaveTradeObj(VenderBean vb, JSONObject trade) {
        ...
        executePost("https://vend-system.happyice.com.sg/api/v1/vending-machine-transaction", "收到一条交易记录"+trade.toString());
