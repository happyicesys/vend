...
public class DBConnectionManager {
	 ...
	 * @param con
	 */
	public void freeConnection(String name, Connection con,ResultSet rs,Statement s) 
	{
		if(rs!=null)
		{
			try {
	...
	public void freeConnection(String name, Connection con,ResultSet rs,PreparedStatement s) 
	{
		if(rs!=null)
		{
			try {
