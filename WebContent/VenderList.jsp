										...
										<td class="center col-md-1">
											<%
												if(0!=(Function_flg&VenderBean.FUNC_IS_TERMPER_VALID))
												{
													...
													{
														if(!obj.isIsOnline()) {
															out.print(String.format("<button onclick='ShowTemCurve(%d);'  type='button' class='btn btn-secondary btn-sm' style='background-color:#777;border-color:#fff;font-weight: 700;margin-right: 3px;color: white;'>Temp:%1.1f℃</button>",obj.getId(),obj.getTemperature()/10.0));
														}else {
